...
if __name__ == '__main__':
    ...
    response_file_names = os.listdir("data/response")

    # sort the file names
    response_file_names.sort()

    # get the file paths
    response_file_paths = [os.path.join("data/response", file_name) for file_name in response_file_names]
    ...
    with open("data/combined/combined.json", 'w') as f:
